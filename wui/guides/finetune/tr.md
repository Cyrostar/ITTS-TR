...
Diğer modüllerden farklı olarak ince ayar, yapılandırma uyuşmazlıklarını önlemek için büyük ölçüde otomasyona güvenir.
...
- **Çalıştırma Adı (Run Name):** Kontrol noktalarının (checkpoints) ve TensorBoard günlüklerinin kaydedileceği `finetunes/` dizini altındaki klasör adını tanımlar. Boş bırakılırsa, varsayılan olarak proje adını alır.
