...
- **Nombre de la Ejecución (Run Name):** Define el nombre de la carpeta bajo el directorio `finetunes/` donde se guardarán los puntos de control (checkpoints) y los registros de TensorBoard. Si se deja en blanco, toma por defecto el nombre del proyecto.
